        ...
        return [
            [
                ...
                'children' => [
                    ...
                    [
                        ...
                        'lists' => [
                            [
                                ...
                                'Viết các bài kiểm thử đơn vị (unit tests) và kiểm thử tính năng (feature tests) sử dụng PHPUnit để đảm bảo chất lượng mã nguồn và độ tin cậy của hệ thống.',
                    ...
                    [
                        ...
                        'lists' => [
                            [
                                'Giai đoạn 1 - Phân tích yêu cầu: Nghiên cứu các hệ thống hiệu sách điện tử hiện có (Amazon Kindle, Google Play Books), xác định các chức năng cốt lõi, phân tích yêu cầu chức năng và phi chức năng, xác định các tác nhân (người dùng, admin), vẽ sơ đồ ca sử dụng (use case diagram).',
                                ...
                                'Giai đoạn 5 - Kiểm thử: Viết các bài kiểm thử đơn vị (unit tests) và kiểm thử tính năng (feature tests) cho backend (PHPUnit), kiểm thử API với Postman, kiểm thử giao diện người dùng thủ công trên các nền tảng (iOS, Android, web, desktop), kiểm thử tích hợp đầu-cuối (đăng ký → duyệt → mua → đọc → đánh giá), kiểm thử hiệu năng (thời gian phản hồi, truy vấn cơ sở dữ liệu).',
                    ...
                    [
                        ...
                        'lists' => [
                            [
                                ...
                                'Chương 3 - Phân tích và thiết kế hệ thống: Phân tích yêu cầu chức năng và phi chức năng, mô tả sơ đồ ca sử dụng (use case diagram), trình bày kiến trúc tổng thể, thiết kế cơ sở dữ liệu (ERD), và thiết kế API.',
                    ...
                    [
                        ...
                        'lists' => [
                            [
                                ...
                                'Xác thực dữ liệu (Validation): Hệ thống kiểm tra tính hợp lệ dữ liệu mạnh mẽ, hỗ trợ nhiều quy tắc và có thể tùy chỉnh.',
                                ...
                                'Kiểm thử (Testing): Tích hợp PHPUnit, hỗ trợ viết các bài kiểm thử đơn vị (unit tests) và kiểm thử tính năng (feature tests).',
            ...
            [
                ...
                'children' => [
                    ...
                    [
                        ...
                        'lists' => [
                            [
                                ...
                                'NFR5 - Khả năng bảo trì: Mã nguồn phải tuân theo quy ước lập trình (coding conventions), có chú thích (comments) và tài liệu đầy đủ. Sử dụng hệ thống kiểm soát phiên bản (Git). Có các bài kiểm thử đơn vị (unit tests) và kiểm thử tính năng (feature tests) để đảm bảo chất lượng mã nguồn.',
                    ...
                    [
                        'title' => 'Sơ đồ ca sử dụng',
                        'level' => 2,
                        'paragraphs' => [
                            'Sơ đồ ca sử dụng (use case diagram) mô tả các tương tác giữa các tác nhân (người dùng và quản trị viên) với hệ thống. Các tác nhân chính bao gồm:',
                        ],
                        'lists' => [
                            [
                                'Khách (Guest): Người dùng chưa đăng nhập, chỉ có thể xem danh sách sách, chi tiết sách, đăng ký, và đăng nhập.',
                                'Người dùng (User): Người dùng đã đăng nhập, có thể thực hiện tất cả chức năng của Khách, cộng thêm mua sắm, quản lý ví, đọc sách đã mua, viết đánh giá.',
                                'Quản trị viên (Admin): Có tất cả quyền của Người dùng, cộng thêm quản lý người dùng, sách, tác giả, thể loại, đơn hàng, yêu cầu nạp tiền, và điều chỉnh ví.',
                            ],
                        ],
                        'paragraphs' => [
                            'Các ca sử dụng chính bao gồm: Đăng ký (Khách), Đăng nhập (Khách), Xem danh sách sách (Khách/Người dùng/Quản trị viên), Xem chi tiết sách (Khách/Người dùng/Quản trị viên), Thêm vào giỏ hàng (Người dùng), Thanh toán (Người dùng), Xem lịch sử đơn hàng (Người dùng), Quản lý ví (Người dùng), Đọc sách (Người dùng), Viết đánh giá (Người dùng), Quản lý người dùng (Quản trị viên), Quản lý sách (Quản trị viên), Quản lý tác giả (Quản trị viên), Quản lý thể loại (Quản trị viên), Xử lý yêu cầu nạp tiền (Quản trị viên), Điều chỉnh ví (Quản trị viên).',
                            'Do giới hạn của định dạng văn bản, sơ đồ ca sử dụng chi tiết được trình bày trong Phụ lục A.',
                        ],
                    ],
                    [
                    ...
                    [
                        ...
                        'children' => [
                            [
                                ...
                                'lists' => [
                                    [
                                        ...
                                        'tests/Feature: Chứa các bài kiểm thử tính năng (feature tests).',
                            ...
                            [
                                ...
                                'level' => 3,
                                'paragraphs' => [
                                    'Các bộ điều khiển (controllers) được tổ chức theo mẫu tài nguyên (resource pattern). Mỗi tài nguyên (Book, Author, Category, Order, v.v.) có một controller chứa các phương thức: index (danh sách), show (chi tiết), store (tạo mới), update (cập nhật), destroy (xóa). Các controller sử dụng kiểm tra tính hợp lệ yêu cầu (Request validation) để xác thực dữ liệu đầu vào, sử dụng Eloquent để truy vấn cơ sở dữ liệu, và trả về phản hồi JSON.',
                            ...
                            [
                                ...
                                'lists' => [
                                    ...
                                    [
                                        ...
                                        'Kiểm thử widget kiểm tra tính hợp lệ dữ liệu đầu vào: nhập ký tự không hợp lệ thì viền chuyển sang màu đỏ.',
                ...
                'children' => [
                    [
                        ...
                        'paragraphs' => [
                            ...
                            'Đối với tính năng trích xuất văn bản, bộ kiểm thử tính năng (feature test) chuyên biệt được xây dựng trong BookTextExtractionTest nhằm bao phủ đầy đủ các nhánh logic của dịch vụ và bộ điều khiển.',
                        ],
                        'lists' => [
                            [
                    ...
                    [
                        ...
                        'lists' => [
                            [
                                ...
                                'Kiểm thử widget về kiểm tra tính hợp lệ dữ liệu đầu vào: Nhập chuỗi "abc123" vào trường văn bản (TextField), kiểm tra viền chuyển màu đỏ, văn bản trợ giúp hiển thị. Nhập "1,5,10" thì viền chuyển xanh, văn bản trợ giúp biến mất.',
                    ...
                    [
                        ...
                        'level' => 2,
                        'paragraphs' => [
                            'Tất cả các bài kiểm thử tính năng của backend đều vượt qua, độ phủ khoảng 70% (đo bằng báo cáo độ phủ của PHPUnit). Các điểm cuối API hoạt động đúng theo đặc tả, kiểm tra tính hợp lệ đúng, xử lý lỗi đúng.',
                    ...
                    [
                        ...
                        'lists' => [
                            [
                                ...
                                'Có các bài kiểm thử đơn vị (unit tests) và kiểm thử tính năng (feature tests), đảm bảo chất lượng mã nguồn.',
            ...
            [
                ...
                'children' => [
                    [
                        ...
                        'lists' => [
                            [
                                'Phân tích và thiết kế hệ thống: Xác định yêu cầu chức năng và phi chức năng, vẽ sơ đồ ca sử dụng (use case diagram), thiết kế kiến trúc tổng thể, thiết kế cơ sở dữ liệu (ERD), thiết kế API.',
                                'Lập trình backend với Laravel: Eloquent ORM, migrations, seeders, factories, xác thực với Sanctum, RESTful API, controllers, routes, middleware, kiểm tra tính hợp lệ (validation), tải lên/tải xuống tệp, tích hợp Tesseract OCR, queue jobs, kiểm thử tính năng với PHPUnit.',
                                ...
                                'Kiểm thử: Kiểm thử đơn vị (unit tests), kiểm thử tính năng (feature tests), kiểm thử tích hợp, kiểm thử thủ công, kiểm thử hiệu năng.',
                    ...
                    [
                        ...
                        'lists' => [
                            [
                                ...
                                'Độ phủ kiểm thử chưa cao: Chỉ có các bài kiểm thử tính năng cho một số luồng chính, chưa có kiểm thử đơn vị cho tất cả dịch vụ (services) và widgets. Cần bổ sung thêm các bài kiểm thử để đảm bảo chất lượng.',
