                        ...
                        'children' => [
                            ...
                            [
                                ...
                                'paragraphs' => [
                                    ...
                                    'Service tích hợp được xây dựng theo mẫu repository pattern, tách biệt logic gọi API và xử lý lỗi khỏi UI. PdfTextService chứa phương thức extractText(int bookId, String? pages) trả về đối tượng ExtractedText với các thuộc tính text, totalPages, extractedPages và pageCount. Service xử lý các lỗi phổ biến:',
